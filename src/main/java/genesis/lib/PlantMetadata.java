...
public final class PlantMetadata {
    ...
    public static final String ARCH_NAME = "archaeopteris", SIGIL_NAME = "sigillaria", LEPID_NAME = "lepidodendron", CORD_NAME = "cordaites", PSAR_NAME = "psaronius", BJUVIA_NAME = "bjuvia", GLOSSO_NAME = "glossopteris", ARAUC_NAME = "auracarioxylon";
