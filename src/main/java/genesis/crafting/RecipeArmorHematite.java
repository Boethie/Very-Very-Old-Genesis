...
public class RecipeArmorHematite implements IRecipe
{
    ...
    public boolean matches(InventoryCrafting par1InventoryCrafting, World par2World)
    {
        ...
        for (int i = 0; i < par1InventoryCrafting.getSizeInventory(); ++i){
            ...
            if (itemstack1 != null){
                ...
                {
                    if (itemstack1.getItem() != ModItems.hematite && itemstack1.getItem() != Items.dye)
                    {
                        return false;
                    }
            ...
            if (itemstack1 != null)
            {
                ...
                else
                {
                    ...
                    if (itemstack1.getItem() == Items.dye){
                    	afloat = EntitySheep.fleeceColorTable[BlockColored.func_150032_b(itemstack1.getItemDamage())];
                    }else{
                    	afloat = EntitySheep.fleeceColorTable[BlockColored.func_150032_b(1)];
                    }
