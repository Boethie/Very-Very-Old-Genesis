...
public class GuiPolissoir extends GuiContainer {
    public static final ResourceLocation polissoirGuiTextures = new ResourceLocation(Genesis.ASSETS + "textures/tiles/container/polissoir.png");
    private TileEntityPolissoir polissoir;

    public GuiPolissoir(InventoryPlayer playerInv, TileEntityPolissoir tilePolissoir) {
