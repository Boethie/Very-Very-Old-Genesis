...
public class GuiStorageBox extends GuiContainer{
	...
	private static final ResourceLocation texture = new ResourceLocation(Genesis.MOD_ID, "textures/tiles/container/storage_box.png");
	private IInventory upperChestInventory;
	private IInventory lowerChestInventory;
	private int inventoryRows;

	public GuiStorageBox(IInventory player, IInventory inv)
	{
		super(new ContainerChest(player, inv));
