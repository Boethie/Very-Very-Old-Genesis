...
public class ModelEryops extends ModelBase {
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
        ...
        tail4.rotateAngleX = 0.040F * MathHelper.sin(0.025F * par3);
        tail4.rotateAngleY = 0.100F * MathHelper.sin(0.05F * par3);
        tail3.rotateAngleX = 0.030F * MathHelper.sin(0.025F * par3 + 0.2F);
        tail3.rotateAngleY = 0.075F * MathHelper.sin(0.05F * par3 + 0.2F);
        tail2.rotateAngleX = 0.020F * MathHelper.sin(0.025F * par3 + 0.4F);
        tail2.rotateAngleY = 0.050F * MathHelper.sin(0.05F * par3 + 0.4F);
        tail1.rotateAngleX = 0.010F * MathHelper.sin(0.025F * par3 + 0.6F);
        tail1.rotateAngleY = 0.025F * MathHelper.sin(0.05F * par3 + 0.6F);
    }
}
