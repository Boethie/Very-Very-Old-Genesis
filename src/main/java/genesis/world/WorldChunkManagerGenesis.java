...
public class WorldChunkManagerGenesis extends WorldChunkManager {
    ...
    public WorldChunkManagerGenesis(long par1, WorldType par3WorldType) {
        this();
        GenLayer[] agenlayer = GenLayerGenesis.initializeAllBiomeGenerators(par1, par3WorldType);
        agenlayer = getModdedBiomeGenerators(par3WorldType, par1, agenlayer);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public WorldChunkManagerGenesis(World par1World) {
