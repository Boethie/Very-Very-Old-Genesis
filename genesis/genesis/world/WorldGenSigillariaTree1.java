...
public class WorldGenSigillariaTree1 extends WorldGenerator{
	
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        int l = par2Random.nextInt(3) + 10;
        int i1 = l - par2Random.nextInt(1) - 3;
        int j1 = l - i1;
        int k1 = 1 + par2Random.nextInt(1);
        boolean flag = true;
            ...
            else
            {
                ...
                if ((l1 == Block.grass.blockID || l1 == Block.dirt.blockID) && par4 < 128 - l - 1)
                {
                    ...
                    for (i2 = par4 + l; i2 >= par4 + i1; --i2)
                    {
                        for (j2 = par3 - l2; j2 <= par3 + l2; ++j2)
                        {
                            ...
                            for (int i3 = par5 - l2; i3 <= par5 + l2; ++i3)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, j2, i2, i3, Blocks.blockLeavesGenesis1.blockID, 1);
                                }
                            }
                        }
                    ...
                    for (i2 = 0; i2 < l - 1; ++i2)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + i2, par5, Blocks.blockLogGenesis1.blockID, 1);
                        }
                    }
