...
public class TileEntityCampfireRenderer extends TileEntitySpecialRenderer
{
	...
	protected void renderItemStack(ItemStack stack)
	{
        ...
        if (customRenderer == null && (stack.getItemSpriteNumber() != 0 || !RenderBlocks.renderItemIn3d(Block.blocksList[stack.itemID].getRenderType())))
        {
            GL11.glScalef(1, 1, 3);
		...
		{
			mc.entityRenderer.itemRenderer.renderItem(mc.thePlayer,
					stack, pass, ItemRenderType.EQUIPPED);
		}
	}
	 ...
	 */
	public void renderTileEntityCampfireAt(TileEntityCampfire campfire, double x, double y, double z,
			float partialTick)
	{
		GL11.glPushMatrix();
		...
		Random blockRand = campfire.blockCampfire.getRandomAt(campfire.worldObj, campfire.xCoord,campfire.yCoord, campfire.zCoord);
		
		GL11.glRotatef(campfire.blockCampfire.getBlockRotationAt(campfire.worldObj,
				campfire.xCoord, campfire.yCoord, campfire.zCoord) - 90, 0, 1, 0);
