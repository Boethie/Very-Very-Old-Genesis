...
public class ItemSets {
	...
	public static class ItemsSuitOfArmor implements IRecipeWithDefault {
		...
		public ItemsSuitOfArmor(int startID, EnumArmorMaterial armorMaterial, String materialName, Object crafting) {
	...
	public static class ItemsToolSet implements IRecipeWithDefault {
		...
		public ItemsToolSet(int startID, EnumToolMaterial toolMaterial, String materialName, Object crafting, Object craftingHandle) {
			sword = new ItemGenesisSword(startID, toolMaterial, materialName);
			dagger = new ItemGenesisDagger(startID + 1, toolMaterial, materialName);
			pickaxe = new ItemGenesisPickaxe(startID + 2, toolMaterial, materialName);
			axe = new ItemGenesisAxe(startID + 3, toolMaterial, materialName);
			spade = new ItemGenesisSpade(startID + 4, toolMaterial, materialName);
			hoe = new ItemGenesisHoe(startID + 5, toolMaterial, materialName);
